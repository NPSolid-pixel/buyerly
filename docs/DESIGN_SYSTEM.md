...
- STOP, START и изменение бюджета требуют отдельного контекстного подтверждения перед create/edit mutation; удаление правила заранее сообщает число связанных кабинетов и последствия отвязки;
