...
Интерфейс платформы выполнен в дизайн-системе Attio CRM: высокая информационная плотность, нейтральная палитра, чистые SVG-иконки, интерактивная сетка данных, глобальный поиск и настраиваемый сайдбар.

## Возможности

### Интерфейс в стиле Attio CRM
