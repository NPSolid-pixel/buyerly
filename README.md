...
Тесты покрывают движок правил, API и права доступа, парсер кабинетов, идемпотентность worker, аудит и отмену, валюты, примеры правил, KPI-контракт интерфейса, миграции и production-деплой.
