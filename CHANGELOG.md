...
- **Завершение экрана «Автоматизации» и конструктора правил (`BL-105`, `86eyr606z`)**:
  ...
  - Опасные STOP/START/изменения бюджета требуют контекстного подтверждения, а create/edit/group/bulk mutations защищены от повторной отправки явными busy/disabled states.
