...
- **Доверительный Meta connection flow**:
  ...
  - Финальный security review закрыл callback уже отозванного/истёкшего инвайта, запретил глобальный Meta revoke при использовании профиля в другом workspace и исключил захват чужого legacy-кабинета без workspace.
