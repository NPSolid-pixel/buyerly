...
- **Today Decision Center**:
  ...
  - **BL-103 (`86eyrx9c3`)** завершает рабочее пространство: добавлены период, валюта, источник, freshness и качество данных, KPI Spend/лиды/регистрации/покупки и честное сравнение «сегодня / вчера» на сохранённых или fact-store данных без принудительного запроса Meta.
  - Расходы и события показаны семантическими сравнительными полосами, воронка — подтверждёнными шагами, а фактические разрывы кабинетов — отдельным списком с причиной, эффектом и безопасным переходом к кабинету.
  - Мультивалютный Spend никогда не складывается и не сравнивается; аналитическая ошибка не скрывает health/connection/automation сигналы, а loading, empty, error и partial-data состояния получили доступные `aria-live` контракты и единый retry.
